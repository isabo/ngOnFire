...
"$q"]})();function w(f,q){function g(){}g.prototype=q.prototype;f.b=q.prototype;f.prototype=new g;f.prototype.constructor=f;f.a=function(f,e,g){for(var n=Array(arguments.length-2),h=2;h<arguments.length;h++)n[h-2]=arguments[h];return q.prototype[e].apply(f,n)}};
