...
c))&&"function"===typeof c.then&&b.push(g.when(c))});return g.all(b)};e.prototype.$whenLoaded=function(){return g.when(this.$$loadPromise_)};e.prototype.$dispose=function(){for(var a=this.$$model_,b=a.keys(),c=0;c<b.length;c++)h.call(this,b[c],!0);a.dispose();this.$$model_=null};l="key exists hasChanges save set remove containsKey keys count".split(" ");for(p in l)m=l[p],e.prototype["$"+m]=t(m);return function(a){return v(a)}}angular.module("ngOnFire").factory("$model",f);f.$inject=["$rootScope",
